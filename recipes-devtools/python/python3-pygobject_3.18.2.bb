...
DEPENDS += "python3 glib-2.0 cairo freetype fontconfig libpng libxext pixman libxrender"
...
do_install_append() {
  rm -fv ${D}/usr/include/pygobject-3.0/pygobject.h
  rm -fv ${D}/usr/lib/pkgconfig/pygobject-3.0.pc
}
